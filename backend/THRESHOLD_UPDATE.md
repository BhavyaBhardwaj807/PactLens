...
> This file contains **manual instructions** and is intentionally **not executable code**.

---

## FILE 1: backend/app/config.py

**Add after** `top_k_similar: int = 5`:
...
**Add after** `from json import JSONDecodeError`:

```python
from app.config import settings
```

**Inside** `analyze_contradictions`, **after** `llm_calls = 0`:
...
**Replace the similarity filter block** with:
